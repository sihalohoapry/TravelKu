...
class DaftarTravelAllAdapter(
    private var data: List<TravelModul>,
    private val listener: (TravelModul) -> Unit
) : RecyclerView.Adapter<DaftarTravelAllAdapter.LeagueViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeagueViewHolder {
        ...
        val inflatedView: View =
            layoutInflater.inflate(R.layout.item_daftar_travel_all, parent, false)
