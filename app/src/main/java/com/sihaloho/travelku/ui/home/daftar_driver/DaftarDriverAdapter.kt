...
class DaftarDriverAdapter(
    private var data: List<UserDriver>,
    private val listener: (UserDriver) -> Unit
) : RecyclerView.Adapter<DaftarDriverAdapter.LeagueViewHolder>() {
    ...
    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(data: UserDriver, listener: (UserDriver) -> Unit, context: Context, position: Int) {
