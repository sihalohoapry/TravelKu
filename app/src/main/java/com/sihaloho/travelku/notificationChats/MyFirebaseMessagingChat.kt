package com.sihaloho.travelku.notificationChats
...
import com.sihaloho.travelku.notificationbooking.OreoNotification

class MyFirebaseMessagingChat : FirebaseMessagingService() {
    ...
    private fun sendNotif(mRemoteMessage: RemoteMessage) {
        ...
        val bundel = Bundle()
        bundel.putString("visit_id",user)
        intent.putExtras(bundel)
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)

        val penddingIntent = PendingIntent.getActivity(this, j, intent, PendingIntent.FLAG_ONE_SHOT)

        val defauldSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
    ...
    private fun sendOreoNotif(mRemoteMessage: RemoteMessage) {
        ...
        val builder: Notification.Builder = oreoNotification.getOreoNotification(title,body,penddingIntent,defauldSound, icon)
