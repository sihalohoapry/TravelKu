...
import com.sihaloho.travelku.activity.ViewFullmageActivity
...
class ChatsAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //pesanfoto
        if (chat.getMessage().equals("mengirim foto")&& !chat.getUrl().equals("")){
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("Chats")
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful)
                {
                    ...
                    Toast.makeText(holder.itemView.context, "Gagal Menghapus", Toast.LENGTH_SHORT ).show()
